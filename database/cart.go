...
func AddProductToCart(ctx context.Context, prodCollection, userCollection *mongo.Collection, productID primitive.ObjectID, userID string) error {
	...
	// $each key for pushing each element of the productcart array into the usercart array
...
func BuyItemFromCart(ctx context.Context, userCollection *mongo.Collection, userID string) error {
	...
	// aggregation pipeline to get the total price of the cart
	...
	// pushing the object into the orders array of user collection
	filter := bson.D{primitive.E{Key: "_id", Value: id}}
	...
	// pushing the cart items into the orders.order_list array of the user collection
...
func InstantBuyer(ctx context.Context, prodCollection, userCollection *mongo.Collection, productID primitive.ObjectID, UserID string) error {
	...
	// pushing the product item into the orders.order_list array of the user collection
	filter2 := bson.D{primitive.E{Key: "_id", Value: id}}
