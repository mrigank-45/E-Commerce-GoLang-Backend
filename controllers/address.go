...
func AddAddress() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// aggregation pipeline to get the count of the addresses of this user
...
func DeleteAddress() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// You can either delete that value or set that value to 0
		// deleteCount, err := UserCollection.DeleteOne(context.Background(), filter)

		// setting the address value to 0 in the user model (as addresses is empty)
